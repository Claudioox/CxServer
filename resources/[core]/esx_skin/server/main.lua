...
RegisterServerEvent('esx_skin:responseSavedsadaSkin')
AddEventHandler('esx_skin:responseSavedsadaSkin', function(skin)
...
TriggerEvent('es:addGroupCommand', 'skin', 'admin', function(source, args, user)
	...
	exports["mythic_notify"]:SendAlert("error", source, { args = { 'Permisos insuficientes.' } })
end, {help = _U('skin')})
